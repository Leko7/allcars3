...
#         image_paths = [os.path.join(gen_folder, img) for img in images]
#         serialized_images = pickle.dumps(image_paths)  # Serialize the list of image paths
#         image_data.append({"unique_gen": unique_gen, "images": serialized_images})

# image_df = pd.DataFrame(image_data)

# # Create second table
# image_df.to_sql("unique_gen_images", conn, if_exists="replace", index=False, 
#                 dtype={"images": "BLOB"})  # Store serialized images as BLOB
